...
-309 220 -54 7 -57 6 -57 -15z" />
            ...
            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                    <h2 class="card-title fw-bold mb-1">Alteração de Senha 🔒</h2>
                    <p class="card-text mb-2">Por favor, informe sua nova senha!</p>
                    <form class="mt-2 validate-form" action="{{ url('/login/reset-senha') }}" method="post">
                        @csrf
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge form-password-toggle">
                                <input class="form-control form-control-merge" id="senha" type="password" name="senha"
                                    placeholder="············" aria-describedby="senha" autofocus="" tabindex="1" />
                                <span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                            </div>
                        </div>
                        <div class="mb-1">
                            <div class="d-flex justify-content-between">
                                <label class="form-label" for="senha_confirmation">Confirme a Senha</label>
                            </div>
                            <div class="input-group input-group-merge form-password-toggle">
                                <input class="form-control form-control-merge" id="senha_confirmation" type="password"
                                    name="senha_confirmation" placeholder="············"
                                    aria-describedby="senha_confirmation" tabindex="2" />
                                <span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                            </div>
                        </div>
                        <button class="btn btn-primary w-100" tabindex="3">Alterar Senha</button>
                    </form>
...
@section('page-script')
    <script src="{{ asset(mix('js/scripts/pages/reseta-senha.js')) }}"></script>
@endsection
