...
@section('content')
    ...
    <section class="app-user-list">
        ...
        <div class="card">
                ...
                <div class="dt-action-buttons text-end">
                    @can('criar materiais')
                        <div class="dt-buttons d-inline-flex">
                            <button class="dt-button create-new btn btn-primary" tabindex="0" id="new-materiais"
                                type="button" data-bs-toggle="modal" data-bs-target="#materiais"><span><i
                ...
                <table id="tabela-dados" class="table" style="width:100%">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th>Status</th>
                            <th>Observação</th>
                            @canany(['editar materiais', 'deletar materiais'])
                                <th>Ações</th>
                            @endcanany
                        </tr>
                    </thead>
            ...
            @canany(['criar materiais', 'editar materiais'])
                <div class="modal fade" id="materiais" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <form id="form-materiais" class="add-new-user modal-content pt-0" method="post"
                                action="{{ route('materiais-save') }}">
                                @csrf
...
@section('page-script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#new-materiais").click(function() {
                form.attr('action', "{{ route('materiais-save') }}").reset()
            });

            $(".editar").click(function() {
                json = $(this).data('json')
                form.attr('action', '/materiais/save/' + json.id)
                for (var v in json) {
                    if (v == 'valor') {
            ...
            $(".ativar_desativar").click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        window.location.href = '/materiais/ativa_desativa/' + id;
