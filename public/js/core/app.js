    ...
    (function (a, e, t) {
        ...
        if (
            ...
            t(a).on("load", function () {
                ...
                t(".char-textarea").on("keyup", function (e) {
                    ...
                    (s = this),
                        ...
                        (function (a) {
                            ...
                            (s.value.length < l - 1 &&
                                (s.value = s.value.substring(0, l))),
                        t(".char-count").html(s.value.length),
                        s.value.length > l
                            ? (r.css("background-color", a.colors.solid.danger),
                              i.css("color", a.colors.solid.danger),
                              i.addClass("max-limit"))
                            : (r.css(
                                  "background-color",
                                  a.colors.solid.primary
                              ),
                              i.css("color", o),
                              i.removeClass("max-limit")),
                ...
                m.length > 0 &&
                    m[0].addEventListener("ps-scroll-y", function () {
        ...
        if (
            ...
            var u = t("html")[0].lang;
            if (null !== u) {
                var m = t(".dropdown-language")
                        .find("a[data-language=" + u + "]")
                        .text(),
                    f = t(".dropdown-language")
                        .find("a[data-language=" + u + "] .flag-icon")
                        .attr("class");
                t("#dropdown-flag .selected-language").text(m),
                    t("#dropdown-flag .flag-icon").removeClass().addClass(f);
            }
        } else
        ...
        var p = t(".search-input input").data("search"),
            ...
            C = t(".nav-link-search"),
            k = t(".search-input"),
            y = t(".search-input input"),
            w = t(".search-input .search-list"),
            x = t(".app-content"),
            ...
            (g.on("click", function (a) {
                ...
                for (var o = 0; o < e.length; o++) {
                    ...
                    if (t(e[o].firstChild.firstChild).hasClass("feather")) {
                        var i =
                            e[o].firstChild.firstChild.getAttribute("class");
                        (l = i.split("feather-")[1].split(" ")[0]),
                            (r = i.split("feather-")[1].split(" ")[1]);
                    }
                    s +=
                        ...
                        feather.icons[l].toSvg({ class: "me-75 " + r }) +
                        "<span>" +
        ...
        t(".search-list-bookmark").length &&
                ...
                if (
                    ...
                    if (
                        ...
                        x.addClass("show-overlay"),
                            b.focus()
                                ? S.addClass("show")
                                : (w.addClass("show"), S.removeClass("show")),
                            !1 === n &&
                                (w.addClass("show"), S.removeClass("show"));
                        var o = "",
                            r = "",
                        ...
                        t.getJSON(l + "data/" + p + ".json", function (a) {
                            ...
                            (u = t(".main-search-list-defaultlist").html()),
                                "" == o &&
                                    "" == r &&
                                    (r = t(
                                        ".main-search-list-defaultlist-other-list"
                                    ).html()),
                                (i = d.concat(o, r, u)),
                        ...
                        for (
                            var f = t("ul.nav.navbar-nav.bookmark-icons li"),
                                v = "",
                                g = 0;
                            g < f.length;
                            g++
                            ...
                            var C = "";
                            if (
                                t(f[g].firstChild.firstChild).hasClass(
                                    "feather"
                                )
                            ) {
                                var I =
                                    f[g].firstChild.firstChild.getAttribute(
                                        "class"
                                    );
                            ...
                            v +=
                                ...
                                "<span>" +
                                f[g].firstChild.dataset.bsOriginalTitle +
                                "</span></div>" +
                                feather.icons.star.toSvg({
                                    class: "text-warning bookmark-icon float-end",
                                }) +
                        ...
                        x.hasClass("show-overlay") &&
                            x.removeClass("show-overlay"),
                            w.hasClass("show") && w.removeClass("show");
                }
            }),
            ...
            t(e).on(
                ...
                function (a) {
                    if (
                        (a.stopPropagation(), t(this).hasClass("text-warning"))
                    ) {
                        ...
                        (e = t("ul.nav.navbar-nav.bookmark-icons li")),
                            t(this).addClass("text-warning"),
                            a.preventDefault();
                        var n,
                            o = t(this).parent()[0].href,
                            l = t(this).parent()[0].innerText,
                            r =
                                t(this).parent()[0].firstChild.firstChild
                                    .dataset.icon;
                        t(t(this).parent()[0].firstChild.firstChild).hasClass(
                            "feather"
                        ) &&
                            (r = t(this)
                                .parent()[0]
                            ...
                            (n =
                                ...
                                l +
                                '">' +
                                feather.icons[r].toSvg({ class: "ficon" }) +
                                "</a></li>"),
            ...
            t(a).on("keydown", function (e) {
                ...
                if (
                    ...
                    13 === e.keyCode &&
                        t(".search-list li.current_item").length > 0)
                ) {
            ...
            (e =
                ...
                (function (a) {
                    var e = t(".nav-link-style"),
                        ...
                        r = a || n;
                    s.removeClass(
                        "semi-dark-layout dark-layout bordered-layout"
                    ),
                        "dark-layout" === r
                        ...
                        t("input:radio[data-layout=" + r + "]").length > 0 &&
                            setTimeout(function () {
                                t("input:radio[data-layout=" + r + "]").prop(
                                    "checked",
                                    !0
                                );
                            });
